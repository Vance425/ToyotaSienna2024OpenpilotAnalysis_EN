#!/usr/bin/env python3
"""
Round 5 shaping experiment for the settle-tail sub-phase.

This round extends the strongest current shaping lead:
- low-band catch-up

The purpose is to check whether the monotonic improvement seen through 4.0x
continues into a slightly higher range, or begins to plateau.
"""
...
OUTPUT_DIR = Path(__file__).resolve().parents[1] / "analysis-output" / "transition_settle_shaping_experiment_round5"
...
VARIANTS = [
    {"name": "baseline", "slew": 175.0, "regime_gate": None, "low_band_limit": None, "low_band_boost": 1.0},
    {"name": "low_band_catchup_4p00", "slew": 175.0, "regime_gate": "city_transition_settle_tail", "low_band_limit": 100.0, "low_band_boost": 4.0},
    {"name": "low_band_catchup_4p50", "slew": 175.0, "regime_gate": "city_transition_settle_tail", "low_band_limit": 100.0, "low_band_boost": 4.5},
    {"name": "low_band_catchup_5p00", "slew": 175.0, "regime_gate": "city_transition_settle_tail", "low_band_limit": 100.0, "low_band_boost": 5.0},
    {"name": "low_band_catchup_5p50", "slew": 175.0, "regime_gate": "city_transition_settle_tail", "low_band_limit": 100.0, "low_band_boost": 5.5},
]
